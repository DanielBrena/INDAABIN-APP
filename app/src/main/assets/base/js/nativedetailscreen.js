...
var World = {
	...
	*/
	...
	onPoiDetailMoreButtonClicked: function onPoiDetailMoreButtonClickedFn() {
		...
		var architectSdkUrl = "architectsdk://markerselected?id=" + encodeURIComponent(currentMarker.poiData.id) + "&title=" + encodeURIComponent(currentMarker.poiData.title) + "&description=" + encodeURIComponent(currentMarker.poiData.description) + "&image=" + encodeURIComponent(currentMarker.poiData.image) + "&date=" + encodeURIComponent(currentMarker.poiData.date);
		/*
